...
>> nohup_overcooked_random1_Vanilla.out 2>&1 &
sleep 20
...
# --env-config=overcooked_new with env_args.map_name=unident_s8 \
# >> nohup_overcooked_unident_s8_Vanilla.out 2>&1 &
# sleep 20
...
# >> nohup_overcooked_many_orders_Vanilla.out 2>&1 &
# sleep 20
...
# >> nohup_overcooked_unident_open_Vanilla.out 2>&1 &
# sleep 20