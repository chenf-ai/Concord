...
from hsp.envs.overcooked.overcooked_ai_py.mdp.overcooked_mdp import OvercookedGridworld, BASE_REW_SHAPING_PARAMS
...
class Overcooked(gym.Env):
    ...
    def __init__(self, all_args, run_dir, baselines_reproducible=True, featurize_type=("ppo", "ppo"), stuck_time=4, rank=None):
        """
    ...
    def step(self, action):
        ...
        if self.use_phi:
            ...
            if self.use_hsp:
                ...
                #    print('hsp:',shaped_reward_p0,shaped_reward_p1,joint_action)
            else:
                dense_reward = info["shaped_r_by_agent"]
                shaped_reward_p0 = sparse_reward + self.reward_shaping_factor * dense_reward[0]
                shaped_reward_p1 = sparse_reward + self.reward_shaping_factor * dense_reward[1]
                # if shaped_reward_p0 >0 or shaped_reward_p1 > 0:
                    # print('reward:',shaped_reward_p0,shaped_reward_p1,joint_action)
        if self.store_traj:
