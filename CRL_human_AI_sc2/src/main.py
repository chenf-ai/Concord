...
import sys
import torch as th
from utils.loggingus import get_logger
import yaml

from run import run
from run_CL import run_CL
from run_multitask import run_multitask
from run_recognizer import run_recognizer
...
def my_main(_run, _config, _log):
    ...
    # run the framework
    if config['is_CL']:
        run_CL(_run, config, _log)
    elif config['multi_task']:
        run_multitask(_run, config, _log)
    elif config['is_recognizer']:
        run_recognizer(_run, config, _log)
    else:
